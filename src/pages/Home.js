...
import { faPersonRifle, faArrowLeft, faEnvelope, faPhone, faLocationDot, faWifi, faBatteryHalf, faSignal, faDeleteLeft } from "@fortawesome/free-solid-svg-icons";
            ...
            <div className={styles.contactBox} >
              <div className={styles.contactItemBox}>
                <div className={styles.header}>
                  ...
                  <FontAwesomeIcon icon={faBatteryHalf} className={styles.iconm1} />
                  <FontAwesomeIcon icon={faWifi} className={styles.iconm2} />
                  <FontAwesomeIcon icon={faSignal} className={styles.iconm3} />
                  </div>
                </div>
                ...
                <div className={styles.Information}>
                  <div className={styles.emailInformation}>
                    ...
                    <div className={styles.email}>
                      ...
                      <div className={styles.emailContent}>{contact.email}</div>
                    </div>
                  </div>
                  <div className={styles.phoneInformation}>
                    ...
                    <div className={styles.phone}>
                      ...
                      <div className={styles.phoneContent}>{contact.phone}</div>
                    </div>
                  </div>
                  ...
                  <div className={styles.companyInformation}>
                    <div className={styles.companyIcon}>
                      <FontAwesomeIcon icon={faEnvelope} className={styles.icon4} />
                    </div>
                    <div className={styles.company}>
                      <div className={styles.companyStyle}>User Company</div>
                      <div className={styles.companyContent}>{contact.company.name}</div>
                    </div>
                  </div>
                  <div className={styles.delete} >
                  <FontAwesomeIcon icon={faDeleteLeft} className={styles.icon5} onClick={() =>{onDeleteContact(contact.id)}}/>
                  </div>
                </div>
              </div>
            </div>
